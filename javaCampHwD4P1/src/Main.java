...
public class Main {
	...
	public static void main(String[] args) {
		...
		Customer customer1 = new Customer(1,"Engin","Demiroð",new Date(1985,1,6),"12345678910");
		Customer customer2 = new Customer(2,"Nilgün","Demirkaya",new Date(1996,10,5) ,"10987654321");
